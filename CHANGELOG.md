...
* feat(deps): update crossplane-contrib/function-auto-ready docker tag to v0.6.4 (#31) (by @renovate[bot])

  Co-authored-by: renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>


See full diff: [v0.19.0...v0.20.0](https://github.com/hops-ops/aws-account/compare/v0.19.0...v0.20.0)
