...
EXAMPLE_DEFAULT := examples/accounts/standard.yaml
...
EXAMPLES := \
    examples/accounts/standard.yaml:: \
    examples/accounts/standard.yaml::examples/test/mocks/observed-resources/standard/steps/1 \
    examples/accounts/import.yaml::
